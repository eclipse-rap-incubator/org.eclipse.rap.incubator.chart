...
public class WorldMapChart_Test {
  ...
  @Test
  public void testCreate_requiresGeoProjectionJs() {
    JavaScriptLoader loader = mock( JavaScriptLoader.class );
    fakeLoader( loader );

    new WorldMapChart( shell, SWT.NONE );

    verify( loader ).require( DEF_GEO_PROJECTION_JS_URL );
  }
  ...
  @Test
  public void testCreate_requiresGeoProjectionJS_fromSystemProperty() {
    JavaScriptLoader loader = mock( JavaScriptLoader.class );
    fakeLoader( loader );

    System.setProperty( PROP_GEO_PROJECTION_JS_URL, "custom://url" );
    new WorldMapChart( shell, SWT.NONE );
    System.clearProperty( PROP_GEO_PROJECTION_JS_URL );

    verify( loader, never() ).require( DEF_GEO_PROJECTION_JS_URL );
    verify( loader ).require( "custom://url" );
  }
  ...
  @Test
  public void testSetColors_byMap_isRendered() {
    ...
    JsonObject expectedColors = new JsonObject()
      .add( "DEU", "#c80000" )
      .add( "*", "#006400" )
      .add( "BGR", "#c80000" );
