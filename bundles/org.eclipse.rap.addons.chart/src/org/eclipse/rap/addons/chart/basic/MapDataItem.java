...
public class MapDataItem extends DataItem {
  ...
  /**
   * Create a new map data item with the given country.
   *
  ...
  /**
   * Create a new map data item with the given country and text.
   *
   * @param country the country of the item
  ...
  /**
   * Create a new map data item with the given country, text, and color.
   *
   * @param country the country of the item
   * @param text the tooltip text for the item, or <code>null</code> to omit the tooltip
