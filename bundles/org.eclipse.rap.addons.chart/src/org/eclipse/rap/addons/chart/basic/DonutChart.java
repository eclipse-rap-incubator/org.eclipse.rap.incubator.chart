...
public class DonutChart extends PieChart {
  ...
  /**
   * The corner radius of the slices. Typically used together with padAngle.
   * Default is 0.
   * 
  ...
  /**
   * Percent of pie radius to cut out of the middle to make the donut. 
   * It is multiplied by the outer radius to calculate the inner radius, 
   * thus it should be between 0 and 1. Default is 0.5.
   * 
  ...
  /**
   * Defines the spacing between slices as percentage of the chart.
   * Default is 0.
   * 
  ...
  /**
   * Text to include within the middle of the donut chart.
   * Default is empty.
   * 
