...
public abstract class MapChart extends Chart {
  ...
  private static final String PROP_DATAMAP_JS_URL = "org.eclipse.rap.addons.chart.datamapsJsUrl";

  private static final String DEF_TOPOJSON_JS_URL
    = "https://cdnjs.cloudflare.com/ajax/libs/topojson/1.6.9/topojson.min.js";
  private static final String DEF_DATAMAP_JS_URL
    = "https://cdnjs.cloudflare.com/ajax/libs/datamaps/0.4.4/datamaps.world.min.js";
  ...
  protected MapChart( Composite parent, int style, String renderer ) {
    ...
    requireJs( System.getProperty( PROP_DATAMAP_JS_URL, DEF_DATAMAP_JS_URL ) );
  }
