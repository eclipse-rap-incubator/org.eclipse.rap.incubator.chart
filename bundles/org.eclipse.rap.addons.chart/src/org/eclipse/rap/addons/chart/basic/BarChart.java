...
public class BarChart extends NvChart {
  ...
  private boolean staggerLabels = false;
  ...
  /**
   * Makes the X labels stagger at different distances from the axis so 
   * they are less likely to overlap. Default is <code>false</code>.
   * 
