...
public abstract class NvChart extends Chart {
  ...
  /**
   * Sets the color scale to be used by the chart. This can be used alternatively to specifying the
   * colors individually for every <code>DataItem</code>. Default color scale used by nvd3 is
   * category20.
   *
  ...
  public void setColorScale( RGB[] colorScale ) {
    ...
    if( colorScale != null && !colorScale.equals( this.colorScale ) ) {
      ...
      setOption( "colorScale", toJson( colorScale ) );
    }
  }
